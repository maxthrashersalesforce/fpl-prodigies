...
<div class="container-fluid" style="margin-top: 60px;">
    <div class="row" style="padding: 0 0 5px 0;">
        ...
        <div class="col-xs-4">
<!--            <select id="phase" class="dropdown" title="Select Gameweek or Month">-->
<!--                <option id="1">Gameweek --><?php //echo CURRENT_GW; ?><!--</option>-->
<!--                <option id="6">December</option>-->
<!--            </select>-->
            <div class="dropdown">
...
<script>
    ...
    function get_players(phase) {
        var data = {mode: 'fmlfpl', phase: phase};
